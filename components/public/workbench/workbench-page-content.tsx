...
const wipItems = [
  {
    id: 1,
    name: "Mафия Ad Intelligence",
    description:
      "AI platform that analyzes advertising creatives, landing pages, and messaging patterns to discover high-performing marketing strategies.",
    progress: 82,
  ...
  {
    id: 2,
    name: "Mафия Brand Monitor",
    description:
      "Dashboard that tracks brand mentions, citation rates, and AI prompt responses across multiple platforms.",
    progress: 68,
  ...
  {
    id: 3,
    name: "Mафия Copy Analyzer",
    description:
      "AI tool that evaluates advertising copy for clarity, persuasion strength, and emotional impact.",
    progress: 90,
    lastUpdated: "Feb 2026",
    url: "https://github.com/Zelesen",
    branch: "main",
  ...
  {
    id: 4,
    name: "Mафия Video Analyzer",
    description:
      "Frame extraction and AI analysis system that evaluates visuals, branding presence, and storytelling in video ads.",
    progress: 74,
    lastUpdated: "Jan 2026",
    url: "https://github.com/Zelesen",
    branch: "feature/video-analysis",
    commits: 61,
  },
  {
    id: 5,
    name: "Mафия UI",
    description:
      "Modern UI component library featuring glass-style interfaces built with Tailwind and component primitives.",
    progress: 50,
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/Maфия/active</span>
