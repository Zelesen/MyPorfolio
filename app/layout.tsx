...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://MафияCODE.ir'),
  title: {
    default: "Mафия CODE — Digital Laboratory",
    template: "%s | Mафия CODE",
  },
  description:
  ...
  openGraph: {
    ...
    description: "A digital workshop where code meets curiosity. Experiments, prototypes, and open-source artifacts by Mафия CODE.",
    siteName: "Mафия CODE",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "MафияCODE — Mафия CODE's Digital Laboratory",
      },
    ],
  },
  twitter: {
