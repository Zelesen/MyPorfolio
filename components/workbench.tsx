...
const wipItems = [
  {
    id: 1,
    name: "Mафия Ad Intelligence Engine",
    description:
      "AI system that scans ad creatives and landing pages to identify winning messaging patterns and performance signals.",
    progress: 80,
  ...
  {
    id: 2,
    name: "Mафия Brand Citation Tracker",
    description:
      "Analytics dashboard that tracks brand mentions, citation rates, and AI prompt responses across LLM platforms.",
    progress: 65,
  ...
  },
  {
    ...
    description:
      "AI tool for analyzing ad copy and marketing messages to score persuasion, clarity, and emotional impact.",
    progress: 90,
    lastUpdated: "Feb 2026",
    url: "https://github.com/Zelesen",
  },
  {
    id: 4,
    name: "Mафия Video Ad Analyzer",
    description:
      "Frame extraction and AI analysis system that evaluates visuals, branding, and messaging from video ads.",
    progress: 70,
    lastUpdated: "Jan 2026",
    url: "https://github.com/Zelesen",
  },
