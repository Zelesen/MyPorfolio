          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-3 animate-fade-in-up">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">
                Mафия Code — Where Code Meets Curiosity
              </p>
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Welcome to my coding lab — a place for experiments, prototypes, and
              ambitious ideas. This is where concepts are tested, projects are forged,
              and new technologies are pushed to their limits <span className="text-foreground font-medium">...</span> Not a portfolio.
