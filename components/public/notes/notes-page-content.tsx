...
const notes = [
  {
    id: 1,
    title: "Analyzing High-Performing Ad Creatives with AI",
    excerpt:
      "Exploring how AI can analyze ad creatives to identify patterns in messaging, visual structure, and persuasion techniques used by top-performing campaigns.",
    content:
      "A deep dive into building an AI system that evaluates advertising creatives and extracts insights about copywriting, visual hierarchy, and audience targeting...",
    date: "Feb 2026",
    category: "systems",
  ...
  {
    id: 2,
    title: "Tracking Brand Mentions Across AI Platforms",
    excerpt:
      "Building a system that monitors how brands appear in AI responses and measures citation frequency, prompt categories, and visibility across LLMs.",
    content: "A technical walkthrough of creating a brand citation tracking system powered by AI analysis...",
    date: "Jan 2026",
    category: "ai",
  ...
  {
    id: 3,
    title: "Designing AI Tools for Marketing Analysis",
    excerpt:
      "How modern AI models can be used to analyze marketing campaigns, ad copy, and landing pages to extract actionable insights for growth teams.",
    content: "Practical approaches for building AI-powered marketing analysis tools...",
    date: "Dec 2025",
    category: "frontend",
  ...
  },
  {
    ...
    excerpt:
      "Creating a system that extracts frames from video ads and evaluates visual messaging, branding presence, and creative structure using AI.",
    content: "Step-by-step explanation of building a video ad analysis pipeline using frame extraction and AI models...",
    date: "Oct 2025",
    category: "ai",
  ...
  {
    id: 5,
    title: "Building a Scalable AI Analysis Backend",
    excerpt:
      "Architecting a backend system capable of analyzing thousands of ads and marketing assets using asynchronous processing and AI APIs.",
    content: "Architecture patterns and backend strategies for scalable AI analysis platforms...",
    date: "Sep 2025",
    category: "devops",
  ...
  {
    id: 6,
    title: "Designing Dashboards for AI Insights",
    excerpt:
      "Best practices for designing dashboards that visualize AI-generated insights, metrics, and marketing intelligence data effectively.",
    content: "UI and UX strategies for presenting complex AI analytics data in clear dashboards...",
    date: "Aug 2025",
    category: "frontend",
