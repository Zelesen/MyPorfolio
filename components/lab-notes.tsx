...
const notes = [
  {
    ...
    excerpt:
      "Creating a tool that analyzes advertising copy using AI to score clarity, persuasion, and emotional impact.",
    date: "Feb 2026",
    category: "ai",
  ...
  },
  {
    ...
    excerpt:
      "Developed a dashboard that tracks brand mentions, citation rates, and prompt categories using AI-generated insights.",
    date: "Jan 2026",
    category: "backend",
  ...
  },
  {
    ...
    excerpt:
      "Built a platform similar to the Facebook Ad Library that collects, analyzes, and categorizes ads for marketing research.",
    date: "Nov 2025",
    category: "web",
  ...
  },
  {
    ...
    excerpt:
      "A system that extracts frames from video ads and evaluates visuals and messaging using AI-powered analysis.",
    date: "Sep 2025",
    category: "ai",
