...
url: `https://mafiacode.ir/blog/${post.slug}`,
...
return [
{
url: 'https://mafiacode.ir',
lastModified: new Date(),
changeFrequency: 'weekly',
priority: 1,
},
{
url: 'https://mafiacode.ir/blog',
lastModified: new Date(),
changeFrequency: 'weekly',
priority: 0.9,
},
...
<rss version="2.0">
  <channel>
    <title>Mафия CODE Blog</title>
    <link>https://mafiacode.ir/blog</link>
...
<title>${post.title}</title>
      <link>https://mafiacode.ir/blog/${post.slug}</link>
...
transform: translateZ(0); /_ Force GPU _/
}
\`\`\`
